...
walls = [
    [-1.1, -0.9, 0.0, 5.0],   # Left wall
    [ 0.9,  1.1, 0.0, 5.0],   # Right wall
    [-1.1,  1.1, -0.1, 0.1],  # Closed end (bottom)
]
...
# Save
save_path = '/home/david/mpc_rl_robot_preliminary/results/screenshots/cost_landscape4.png'
